        ...
        $modulos = Matricula::with(['estudiante', 'modulo', 'pagos' => function($query) {
            ...
            ->map(function($matricula) use ($hoy) {
                ...
                return [
                        'id' => $matricula->id,
                        'tipo' => 'modulo',
                        'nombre' => trim(($matricula->estudiante?->nombre ?? 'Sin estudiante') . ' ' . ($matricula->estudiante?->apellido ?? '')),
                        'curso' => $matricula->modulo?->nombre ?? 'Sin módulo',
                        'codigo_modulo' => $matricula->modulo?->codigo ?? 'N/A',
                        ...
                        'duracion_meses' => $matricula->modulo?->duracion_meses ?? 0,
