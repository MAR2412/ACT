            ...
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-4">
                ...
                <div class="flex flex-col sm:flex-row w-full sm:w-auto space-y-3 sm:space-y-0 sm:space-x-2">
                    ...
                    @can('configuracion.roles.crear')
                        <a href="{{ route('roles.create') }}" class="inline-flex justify-center items-center px-4 py-2 bg-green-400 dark:bg-green-400 dark:border-green-500 dark:text-stone-900 dark:hover:bg-green-500 border border-transparent rounded-md font-semibold text-xs text-stone-900 uppercase tracking-widest hover:bg-green-500 focus:bg-green-600 dark:focus:bg-green-700 active:bg-stone-900 dark:active:bg-green-600 focus:outline-none focus:ring-2 dark:focus:ring-green-400 focus:ring-green-400 focus:ring-offset-2 dark:focus:ring-offset-green-600 transition ease-in-out duration-150">
                                    ...
                                    <div class="max-w-xs">
                                        ...
                                        @if(count($groupedPermissions) <= 2)
                                            ...
                                            @foreach($groupedPermissions as $module => $actions)
                                                <div class="mb-2">
                                                    <span class="inline-block bg-green-200 dark:bg-green-200 text-stone-900 dark:text-stone-900  px-2 py-1 rounded text-xs font-medium mb-1">
                                                        {{ ucfirst($module) }}
                                                    </span>
                                            ...
                                            <div class="text-sm">
                                                ...
                                                <div class="mt-1">
                                                    @foreach(array_slice(array_keys($groupedPermissions), 0, 3) as $module)
                                                        <span class="inline-block bg-green-200 dark:bg-green-200 text-stone-900 dark:text-stone-900 px-2 py-0.5 rounded text-xs mr-1">
                                                            {{ ucfirst($module) }}
                                                        </span>
                                                    @endforeach
                        ...
                        <div class="bg-white dark:bg-white/5 p-4 rounded-lg shadow-sm border border-stone-200 dark:border-stone-700">
                            ...
                            <div class="mt-2">
                                ...
                                @if($role->permissions->count() > 0)
                                    ...
                                    @foreach($groupedPermissions as $module => $actions)
                                        <div class="mb-3">
                                            <span class="inline-block bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-200 px-2 py-1 rounded text-xs font-medium mb-1">
                                                {{ ucfirst($module) }}
                                            </span>
