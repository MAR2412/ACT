    ...
    <div class=" mx-auto rounded-lg mt-8 sm:mt-6 lg:mt-4 mb-6">
        ...
        ['key' => 'actions', 'label' => 'Acciones', 'class' => 'text-right'],
                            ...
                            <tr class="hover:bg-stone-50 dark:hover:bg-stone-700 transition-colors">
                                    ...
                                    @if ($session->user_id)
                                        <div class="flex items-center">
                                            <div class="flex-shrink-0 mr-3">
                                                <div
                                                    class="h-8 w-8 rounded-lg bg-green-400 text-stone-900 flex items-center justify-center">
                                                    <span
                                            ...
                                            <div>
                                                ...
                                                <div class="text-stone-500 text-xs">{{ $session->email ?? 'Sin email' }}</div>
                                            </div>
                                        </div>
                                    @else
                                        <div class="flex items-center">
                                            ...
                                            <div>
                                                ...
                                                <div class="text-stone-500 text-xs">Sin autenticar</div>
                                            </div>
                                        </div>
                                    @endif
                                </td>
                                    ...
                                    <div class="flex items-center">
                                        <span class="mr-2">
                                            @if ($session->browser == 'Chrome')
                                                <svg class="w-5 h-5 text-stone-600 dark:text-stone-400"
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-stone-900 dark:text-stone-300">
                                    <div title="{{ \Carbon\Carbon::createFromTimestamp($session->last_activity)->format('d/m/Y H:i:s') }}"
                                        ...
                                        <svg class="w-4 h-4 mr-1.5 text-stone-500 dark:text-stone-400"
                                    ...
                                    <div class="flex justify-end space-x-2">
                                        ...
                                        @if($session->user_id && !$session->is_current_device)
                                            <button wire:click="terminateAllUserSessions({{ $session->user_id }})"
                                                ...
                                                <svg class="w-6 h-6 text-green-400 hover:text-green-500 dark:text-green-400 dark:hover:text-green-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24"
                                                    height="24" fill="none" viewBox="0 0 24 24">
                    ...
                    <x-slot name="mobile">
                        @forelse($sessions as $session)
                            <div
                                class="bg-white dark:bg-stone-800 p-4 rounded-lg shadow-sm border border-stone-200 dark:border-stone-700 mb-4">
                                ...
                                @if($session->user_id)
                                    <div class="flex items-center mb-2">
                                        <div
                                            class="h-8 w-8 rounded-full bg-green-400 text-stone-900flex items-center justify-center mr-2">
                                            <span
                                                class="text-white text-xs font-bold">{{ substr($session->name ?? 'CX', 0, 2) }}</span>
                                        </div>
                                        <div>
                                            <div class="font-medium text-stone-900 dark:text-stone-200">
                                ...
                                @else
                                    <div class="flex items-center mb-2">
                                        ...
                                        <div>
                                            <div class="font-medium text-stone-900 dark:text-stone-200">Invitado</div>
                                            <div class="text-xs text-stone-500 dark:text-stone-400">Sin autenticar</div>
                                        </div>
                                    </div>
                                @endif

                                <div class="grid grid-cols-1 gap-2 text-sm text-stone-600 dark:text-stone-400 mt-2">
                                    <div class="flex items-center">
                                        <span class="mr-2">
                                            @if ($session->browser == 'Chrome')
                                                <svg class="w-4 h-4 text-stone-600 dark:text-stone-400"
                                                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                                                    <path
                                                        d="M12 2C6.5 2 2 6.5 2 12C2 17.5 6.5 22 12 22C17.5 22 22 17.5 22 12C22 6.5 17.5 2 12 2M12 4C14.9 4 17.5 5.5 18.9 7.8C18.6 7.9 15.7 8.9 12 8.9C8.3 8.9 5.1 7.8 4.6 7.6C6 5.4 8.7 4 12 4M4.2 9.3C4.2 9.3 8.7 11.4 13.1 11.4C16.7 11.4 20 10.1 20.3 10C20.3 10 20.6 10.7 20.7 11.5C20.7 11.5 18.5 12.5 17 12.8C14.4 13.2 13 13.7 12.1 15.6C11.3 17.5 10.8 20 10.8 20C10.8 20 8.5 19.7 7.4 18.5C5.6 16.5 5.3 13.4 5.3 12C5.3 10.8 5.6 10.1 5.6 10.1L4.2 9.3M12 7C13.6 7 15 8.3 15 10C15 11.7 13.6 13 12 13C10.4 13 9 11.7 9 10C9 8.3 10.4 7 12 7M12 20C9.1 20 6.5 18.5 5.1 16.2C6.3 16.8 9.6 17.4 11.5 15.5C12.8 14.2 13.4 12.5 13.6 11.6C14.2 11.8 15 12.1 16 12.3C16 12.3 15 16.5 15.7 17.7C16.5 19.8 18.2 20 18.2 20C16.8 20 14.5 20 12 20Z" />
                                                </svg>
    ...
    <x-dialog-modal maxWidth="md" wire:model="viewingSessionDetails">
        ...
        <x-slot name="content">
            @if($sessionDetails)
                <div class="space-y-4">
                    <div>
                        <h3 class="text-sm font-medium text-stone-500 dark:text-stone-400 mb-1">Usuario</h3>
                        <div class="flex items-center">
                            ...
                            @else
                                ...
                                <div>
                                    <div class="font-medium text-stone-900 dark:text-stone-200">Invitado</div>
                                    <div class="text-stone-500 dark:text-stone-400 text-sm">Sin autenticar</div>
                                </div>
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <h3 class="text-sm font-medium text-stone-500 dark:text-stone-400 mb-1">Dirección IP</h3>
                            <p class="text-stone-900 dark:text-stone-200">{{ $sessionDetails->ip_address ?? 'Desconocida' }}
                            </p>
                        </div>
                        <div>
                            <h3 class="text-sm font-medium text-stone-500 dark:text-stone-400 mb-1">Última actividad</h3>
                        ...
                        <div>
                            <h3 class="text-sm font-medium text-stone-500 dark:text-stone-400 mb-1">Navegador</h3>
                            <p class="text-stone-900 dark:text-stone-200">{{ $sessionDetails->browser }}
                                {{ $sessionDetails->browser_version ? 'v' . $sessionDetails->browser_version : '' }}</p>
                        </div>
                        <div>
                            <h3 class="text-sm font-medium text-stone-500 dark:text-stone-400 mb-1">Plataforma</h3>
                            <p class="text-stone-900 dark:text-stone-200">{{ $sessionDetails->platform }}
                                {{ $sessionDetails->platform_version ?? '' }}</p>
                        </div>
                        <div>
                            <h3 class="text-sm font-medium text-stone-500 dark:text-stone-400 mb-1">ID de Sesión</h3>
                            <p class="text-stone-900 dark:text-stone-200 break-all">{{ $sessionDetails->id }}</p>
                        </div>
                        <div>
                            <h3 class="text-sm font-medium text-stone-500 dark:text-stone-400 mb-1">Dispositivo actual</h3>
                            <p class="text-stone-900 dark:text-stone-200">
                                ...
                                @else
                                    <span
                                        class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-stone-100 text-stone-800 dark:bg-stone-700 dark:text-stone-300">No</span>
                                @endif
                            </p>
                        </div>
                    </div>
                    ...
                    @if($sessionDetails->user_agent)
                        <div>
                            <h3 class="text-sm font-medium text-stone-500 dark:text-stone-400 mb-1">User Agent</h3>
                            <p
                                class="text-stone-900 dark:text-stone-200 text-sm break-all bg-stone-50 dark:bg-stone-800 p-2 rounded">
