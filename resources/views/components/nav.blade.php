    ...
    <nav class="flex items-center gap-1 py-3 lg:hidden w-full px-4">
        <div class="flex items-center">
            <button id="sidebarToggleBtn" data-drawer-target="logo-sidebar" data-drawer-toggle="logo-sidebar" aria-controls="logo-sidebar"
                type="button"
                class="inline-flex items-center p-2 text-sm text-green-500 rounded-lg sm:hidden hover:bg-stone-100 focus:outline-none focus:ring-2 focus:ring-stone-200 dark:text-white dark:hover:bg-stone-700 dark:focus:ring-stone-600">
