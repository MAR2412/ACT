...
@php
    ...
    $baseClasses = 'border-stone-300 focus:border-green-500 focus:ring-green-500 dark:focus:border-stone-500 dark:focus:ring-stone-500 rounded-md shadow-sm w-full';
    
    // Agregamos clases específicas para modo oscuro
    $darkModeClasses = 'dark:border-stone-700 dark:bg-stone-900 dark:text-stone-300';
