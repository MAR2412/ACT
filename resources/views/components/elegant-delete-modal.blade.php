...
<x-dialog-modal wire:model="{{ $attributes->get('wire:model', 'showDeleteModal') }}" maxWidth="{{ $maxWidth }}">
    ...
    <x-slot name="content">
        <div class="mt-2">
            ...
            @if($entity || $entityName)
                <div class="mt-4 p-4 bg-stone-50 dark:bg-stone-800 rounded-lg">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <h4 class="text-lg font-medium text-stone-900 dark:text-stone-100">
            ...
            <div class="mt-4 p-3 bg-green-50 dark:bg-green-900 border border-green-200 dark:border-green-700 rounded-md">
                <div class="flex">
                    <div class="flex-shrink-0">
